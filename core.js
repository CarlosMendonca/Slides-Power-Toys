...
function mergeTextAndDeleteShape(shapeToKeep, shapeToDelete) {
  var lastChar = shapeToDelete.getText().getEndIndex(); // necessary to strip the newline character that gets inserted with appendRange
  
  shapeToKeep.getText().appendParagraph("");
  shapeToKeep.getText().appendRange(shapeToDelete.getText().getRange(0, lastChar - 1));
